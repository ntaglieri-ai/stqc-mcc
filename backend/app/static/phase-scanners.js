(() => {
  ...
  function setup(){if(phase==='officina')return;const main=document.querySelector('main');if(!main)return;const button=document.createElement('button');button.className='phase-scanner-button';button.textContent='Lista scanner';button.type='button';button.onclick=open;main.prepend(button);}
